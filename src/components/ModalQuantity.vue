    ...
    <div class="py-4 px-6 flex flex-col">
      ...
      <div class="border-2 border-neutral-700 px-4 py-2 mb-4 relative">
        <div @click="toggleSelect">
          ...
          <div
            class="absolute right-3 inset-y-1/2 cursor-pointer opacity-50"            
          >
            <svg
              class=""
              width="24"
      ...
      <div
        ...
        "
      >
        <div @click="decQuantity" class="cursor-pointer py-1 hover:opacity-50">
          <svg
            width="24"
            height="1"
            viewBox="0 0 24 1"
        ...
        <div @click="incQuantity" class="cursor-pointer py-1 hover:opacity-50">
          <svg
            width="24"
            height="25"
            viewBox="0 0 24 25"
      ...
      <div class="py-3">
        ...
        <div class="flex justify-between">
          <span class="font-montserrat text-lg text-neutral-500">Начало</span>
