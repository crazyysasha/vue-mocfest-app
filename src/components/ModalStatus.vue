<template>
	<div class="border border-white mt-auto">
		...
		<div class="py-4 px-6 flex flex-col">
			...
			<div class="border-2 border-neutral-700 relative px-4 py-3 mb-4">
				<div>
					<h1 class="text-lg mb-1">Гроза</h1>
			...
			<div
				class="flex justify-between items-center border-2 border-neutral-700 relative px-4 py-2 mb-2"
			>
				...
				<div>
					...
					<input type="text" class="bg-transparent text-center" :value="quantity" disabled>
				</div>
				<div @click="incQuantity" class="cursor-pointer	py-2 hover:opacity-50">
					<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M12 0.5L12 12.5M12 24.5L12 12.5M12 12.5L0 12.5M12 12.5L24 12.5" stroke="white"/>
					</svg>
				</div>
			</div>
		</div>
