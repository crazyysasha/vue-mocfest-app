		...
		<div class="gallery">
			<div class="w-full lg:h-screen">
				<div class="columns-2 md:columns-3 lg:columns-4 xl:columns-5 gap-0">
					...
					>
						<img :src="img.path" alt="img" class="w-full" />
					</a>
				</div>
...
const { getImagesFromSettings, isLoading, isLoaded, error, imagesGallery } =
	useSettings();

onMounted(async () => {
	await getImagesFromSettings();
});
